import { submitLogin } from '@/service/submitLogin';
...
export const LoginPageCard = ({ setActiveTab }: Props) => {
    ...
    return (
        <section className="w-1/2 h-screen flex flex-col gap-10 justify-center items-center">
            ...
            >
                <h2 className="text-2xl font-bold text-center text-orange-600">ログイン</h2>
